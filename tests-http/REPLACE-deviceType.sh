...
echo "--- Replace deviceType attribute"
POST_DATA="@REPLACE-deviceType.json"
URL="https://127.0.0.1:8443/restconf/data/ietf-network:networks/network=Inventory1/node=11/asset-inventory-model:device-attributes/deviceType"
...
echo "--- Retrieve network=Inventory, node=11 from start-up configuration"
